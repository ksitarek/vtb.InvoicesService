...
namespace vtb.InvoicesService.Domain.Tests.Invoices
{
    public abstract class InvoiceTests
    {
        ...
        {
            var invoice = new Invoice(DateTime.Today, new Guid("bcea44c9-77c2-4877-a373-3b94e7911464"), new Guid("bcea44c9-77c2-4877-a373-3b94e7911464"), new Guid("bcea44c9-77c2-4877-a373-3b94e7911464"), Currency.EUR, direction);
